...
public class RenderGlobalProxy extends net.minecraft.client.renderer.WorldRenderer
{
    ...
    public void bindViewFrustum(WorldPortal pm)
    {
        ...
        if(vf == null)
        {
            ...
            if(this.world != null)
            {
                ...
                if(entity != null)
                {
                    vf.updateChunkPositions(entity.getPosX(), entity.getPosZ());
    ...
    public void renderEntities(Entity renderViewEntity, ICamera camera, float partialTicks, @Nullable WorldPortal portal, @Nullable WorldPortal pair) // we are rendering the pair's perspective
    {
        ...
        else
        {
            ...
            mc.player.setPosition(playerPosX,playerPosY,playerPosZ);
